...
public class GuiAltManager extends GuiScreen {
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		Exist.normalFontRenderer.font40.drawStringWithShadow(this.mc.session.getUsername(), 10, 10, 0xFFFFFFFF);
		RenderUtils.drawRect(this.width - 370, 8.0F, this.width - 270, 28, Integer.MIN_VALUE);
		Exist.normalFontRenderer.font40.drawCenteredString("Alt Manager", this.width / 2, 10, -1);
		...
		for (Alt alt : Exist.altManager.getAlts()) {
			if (isAltInArea(y)) {
				...
				Exist.normalFontRenderer.font40.drawCenteredString(name, this.width / 4, y - this.offset, -1);
				Exist.normalFontRenderer.font40.drawCenteredString(pass, this.width / 4, y - this.offset + 10, 5592405);
				try {
				...
				if (selectedAlt != null) {
					...
					Exist.normalFontRenderer.font60.drawCenteredString("MAIL", this.width - 200, 160, -1);
					Exist.normalFontRenderer.fontChat.drawCenteredString(selectedAlt.getUsername(), this.width - 200,
							190, -1);
					Exist.normalFontRenderer.font60.drawCenteredString("PASS", this.width - 200, 220, -1);
					Exist.normalFontRenderer.fontChat.drawCenteredString(selectedAlt.getPassword(), this.width - 200,
							250, -1);
				}
				y += 26;
			}
