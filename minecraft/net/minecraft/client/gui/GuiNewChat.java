...
public class GuiNewChat extends Gui {
	...
	public void drawChat(int p_146230_1_) {
		if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN) {
			...
			if (var5 > 0) {
					...
					if (var10 != null) {
						...
						if (var11 < 200 || var3) {
							...
							if (var14 > 3) {
								...
								Exist.normalFontRenderer.fontChat.drawStringWithShadow(var17, (float) var15 + 1,
				...
				if (var3) {
					var9 = Exist.normalFontRenderer.fontChat.FONT_HEIGHT;
	...
	private void setChatLine(IChatComponent p_146237_1_, int p_146237_2_, int p_146237_3_, boolean p_146237_4_) {
		...
		List var6 = GuiUtilRenderComponents.func_178908_a(p_146237_1_, var5, Exist.normalFontRenderer.fontChat, false,
				false);
		...
		if (!this.getChatOpen()) {
			...
			if (var6 >= 0 && var7 >= 0) {
				...
				if (var6 <= MathHelper.floor_float((float) this.getChatWidth() / this.getChatScale())
						&& var7 < Exist.normalFontRenderer.fontChat.FONT_HEIGHT * var8 + var8) {
					int var9 = var7 / Exist.normalFontRenderer.fontChat.FONT_HEIGHT + this.scrollPos;
					...
					if (var9 >= 0 && var9 < this.field_146253_i.size()) {
						...
						while (var12.hasNext()) {
							...
							if (var13 instanceof ChatComponentText) {
								var11 += Exist.normalFontRenderer.fontChat
