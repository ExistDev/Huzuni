...
public class GuiCreateWorld extends GuiScreen {
	...
	public void initGui() {
		...
		this.field_146333_g = new GuiTextField(9, Exist.normalFontRenderer.fontTextField, this.width / 2 - 100, 60, 200,
				20);
		this.field_146333_g.setFocused(true);
		this.field_146333_g.setText(this.field_146330_J);
		this.field_146335_h = new GuiTextField(10, Exist.normalFontRenderer.fontTextField, this.width / 2 - 100, 60,
				200, 20);
