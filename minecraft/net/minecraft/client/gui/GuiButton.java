...
public class GuiButton extends Gui {
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY) {
		if (this.visible) {
			...
			Exist.normalFontRenderer.fontTextField.drawCenteredString(this.displayString,
					this.xPosition + this.width / 2, this.yPosition + (this.height - 8) / 2 - 2,
					hovered ? 0xFF000000 : 0xFFFFFFFF);
		}
	}
