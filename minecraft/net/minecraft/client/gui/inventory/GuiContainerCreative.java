...
public class GuiContainerCreative extends InventoryEffectRenderer {
	...
	public void initGui() {
		if (this.mc.playerController.isInCreativeMode()) {
			...
			this.searchField = new GuiTextField(0, Exist.normalFontRenderer.fontTextField, this.guiLeft + 82,
					this.guiTop + 6, 89, Exist.normalFontRenderer.fontTextField.FONT_HEIGHT);
