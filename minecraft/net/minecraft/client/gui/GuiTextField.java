...
public class GuiTextField extends Gui {
	...
	public void mouseClicked(int p_146192_1_, int p_146192_2_, int p_146192_3_) {
		...
		if (this.isFocused && var4 && p_146192_3_ == 0) {
			...
			String var6 = Exist.normalFontRenderer.fontChat
					.trimStringToWidth(this.text.substring(this.lineScrollOffset), this.getWidth());
			this.setCursorPosition(
					Exist.normalFontRenderer.fontChat.trimStringToWidth(var6, var5).length() + this.lineScrollOffset);
		}
	}
	...
	public void drawTextBox() {
		if (this.getVisible()) {
			...
			String var4 = Exist.normalFontRenderer.fontChat
					.trimStringToWidth(this.text.substring(this.lineScrollOffset), this.getWidth());
			...
			if (var4.length() > 0) {
				...
				var9 = Exist.normalFontRenderer.fontChat.drawStringWithShadow(var10, (float) var7, (float) var8 - 1,
						var1);
			}
			...
			if (var4.length() > 0 && var5 && var2 < var4.length()) {
				var9 = Exist.normalFontRenderer.fontChat.drawStringWithShadow(var4.substring(var2), (float) var9,
						(float) var8, var1);
			}
			...
			if (var6) {
				if (var13) {
					RenderHelper.drawRect(var11, var8 - 1, var11 + 1,
							var8 + 1 + Exist.normalFontRenderer.fontChat.FONT_HEIGHT, 0x40FFFFFF);
				} else {
					Exist.normalFontRenderer.fontChat.drawStringWithShadow("_", (float) var11, (float) var8 - 1, var1);
				}
			}

			if (var3 != var2) {
				int var12 = var7 + Exist.normalFontRenderer.fontChat.getStringWidth(var4.substring(0, var3));
				this.drawCursorVertical(var11, var8 - 1, var12 - 1,
						var8 + 1 + Exist.normalFontRenderer.fontChat.FONT_HEIGHT);
			}
		}
	}
	...
	public void setSelectionPos(int p_146199_1_) {
		...
		if (Exist.normalFontRenderer.fontChat != null) {
			...
			String var4 = Exist.normalFontRenderer.fontChat
					.trimStringToWidth(this.text.substring(this.lineScrollOffset), var3);
			int var5 = var4.length() + this.lineScrollOffset;

			if (p_146199_1_ == this.lineScrollOffset) {
				this.lineScrollOffset -= Exist.normalFontRenderer.fontChat.trimStringToWidth(this.text, var3, true)
						.length();
			}
