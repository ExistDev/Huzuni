...
public class GuiCommandBlock extends GuiScreen {
	...
	public void initGui() {
		...
		this.commandTextField = new GuiTextField(2, Exist.normalFontRenderer.fontTextField, this.width / 2 - 150, 50,
				300, 20);
		this.commandTextField.setMaxStringLength(32767);
		this.commandTextField.setFocused(true);
		this.commandTextField.setText(this.localCommandBlock.getCustomName());
		this.field_146486_g = new GuiTextField(3, Exist.normalFontRenderer.fontTextField, this.width / 2 - 150, 150,
				276, 20);
