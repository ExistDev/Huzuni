...
public class EntityRenderer implements IResourceManagerReloadListener {
	...
	private void hurtCameraEffect(float partialTicks) {
		if (!Exist.moduleManager.getModule(NoHurtTime.class).isToggled()) {
	...
	private void setupViewBobbing(float p_78475_1_) {
		if (this.mc.func_175606_aa() instanceof EntityPlayer) {
			...
			if (Exist.moduleManager.getModule(NoBob.class).isToggled()) {
	...
	private void func_175068_a(int pass, float partialTicks, long finishTimeNano) {
		...
		if (Exist.moduleManager.getModule(Fullbright.class).isToggled()) {
			mc.gameSettings.gammaSetting = 100F;
		}

		// ChestESP
		if (Exist.moduleManager.getModule(ChestESP.class).isToggled()) {
			Object o;
			Iterator var3;
			TileEntityChest chest;
			if (Exist.settingManager.getSetting(Exist.moduleManager.getModule(ChestESP.class), "Mode")
					.getCurrentOption().equalsIgnoreCase("Box")) {
				...
				while (var3.hasNext()) {
					...
					if (o instanceof TileEntityChest) {
						...
						if (Exist.settingManager.getSetting(Exist.moduleManager.getModule(ChestESP.class), "Mode")
								.getCurrentOption().equalsIgnoreCase("CSGO")) {
		...
		if (Exist.moduleManager.getModule(ESP.class).isToggled()) {
			playerESP();
		}
	...
	public void playerESP() {
		...
		while (true) {
			...
			GlStateManager.disableDepth();
			GlStateManager.disableLighting();
			if (Exist.settingManager.getSetting(Exist.moduleManager.getModule(ESP.class), "Mode").getCurrentOption()
				...
				if (entity.hurtTime != 0) {
					...
					Gui.drawRect(30.0D, -79.0D, 9.0D, -74.0D, -16777216);
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(30.0D, -75.0D, 27.0D, -55.0D, ColorUtils.getClientColor().hashCode());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, -75.0D, -27.0D, -55.0D, ColorUtils.getClientColor().hashCode());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(30.0D, -10.0D, 27.0D, 10.0D, ColorUtils.getClientColor().hashCode());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, -10.0D, -27.0D, 10.0D, ColorUtils.getClientColor().hashCode());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, 7.0D, -10.0D, 10.0D, ColorUtils.getClientColor().hashCode());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, -78.0D, -10.0D, -75.0D, ColorUtils.getClientColor().hashCode());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(30.0D, 7.0D, 10.0D, 10.0D, ColorUtils.getClientColor().hashCode());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(30.0D, -78.0D, 10.0D, -75.0D, ColorUtils.getClientColor().hashCode());
			...
			if (Exist.settingManager.getSetting(Exist.moduleManager.getModule(ESP.class), "Mode").getCurrentOption()
				...
				if (entity.hurtTime != 0) {
					...
					Gui.drawRect(-30.0D, -79.0D, 30.0D, -74.0D, -16777216);
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(30.0D, -75.0D, 27.0D, 10.0D, ColorUtils.getClientColor().hashCode());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, -75.0D, -27.0D, 10.0D, ColorUtils.getClientColor().hashCode());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, 7.0D, 30.0D, 10.0D, ColorUtils.getClientColor().hashCode());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-30.0D, -78.0D, 30.0D, -75.0D, ColorUtils.getClientColor().hashCode());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
				}
			}
			...
			if (Exist.settingManager.getSetting(Exist.moduleManager.getModule(ESP.class), "Mode").getCurrentOption()
				...
				if (entity.hurtTime != 0) {
					...
					Gui.drawRect(28.0D, -75.0D, 27.0D, 8.0D, ColorUtils.getClientColor().hashCode());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-28.0D, -75.0D, -27.0D, 8.0D, ColorUtils.getClientColor().hashCode());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-28.0D, 7.0D, 28.0D, 8.0D, ColorUtils.getClientColor().hashCode());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
					Gui.drawRect(-28.0D, -76.0D, 28.0D, -75.0D, ColorUtils.getClientColor().hashCode());
					Gui.drawRect(0.0D, 0.0D, 0.0D, 0.0D, -1);
				}
			}
