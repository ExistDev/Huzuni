...
public abstract class BlockLiquid extends Block {
	...
	public AxisAlignedBB getCollisionBoundingBox(World worldIn, BlockPos pos, IBlockState state) {
		...
		if (Exist.moduleManager.getModule(Jesus.class).isToggled()
				&& Exist.settingManager.getSetting(Exist.moduleManager.getModule(Jesus.class), "Mode")
						.getCurrentOption().equalsIgnoreCase("Solid")
